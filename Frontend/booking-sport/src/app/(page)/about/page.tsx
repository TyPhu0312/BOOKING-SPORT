    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-6 mt-7">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-7xl">
        ...
        <div className="bg-white shadow-xl rounded-2xl p-6 text-center flex flex-col justify-between transition-shadow hover:shadow-2xl">
          ...
          <img src="/images/san1.jpg" alt="Giới thiệu" className="w-full h-48 object-cover rounded-xl" />
        ...
        <div className="bg-white shadow-xl rounded-2xl p-6 text-center flex flex-col justify-between transition-shadow hover:shadow-2xl">
          ...
          <img src="/images/san2.jpg" alt="Dịch vụ" className="w-full h-48 object-cover rounded-xl" />
        ...
        <div className="bg-white shadow-xl rounded-2xl p-6 text-center flex flex-col justify-between transition-shadow hover:shadow-2xl">
          ...
          <img src="/images/san3.jpg" alt="Liên hệ" className="w-full h-48 object-cover rounded-xl" />
          <p className="text-gray-700 mt-4 text-justify">
