    ...
    return (
        <div className="rounded-lg overflow-hidden shadow">
            ...
            <div className="overflow-x-auto">
                {/* Tiêu đề giờ */}
                <div className="grid grid-cols-[auto_repeat(24,_minmax(80px,_1fr))] bg-gray-100 min-w-[2000px]">
                    <div></div>
                ...
                {filteredSchedule.map((day, index) => (
                    <div
                        key={index}
                        className="grid grid-cols-[auto_repeat(24,_minmax(80px,_1fr))] border-b min-w-[2000px]"
                    >
